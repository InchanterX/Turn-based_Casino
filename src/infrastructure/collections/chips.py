...
class Chip:
    ...
    def __add__(self, other):
        ...
        if isinstance(other, Chip) and self.denomination == other.denomination:
            return Chip(self.denomination, self.quantity + other.quantity)
    ...
    def __sub__(self, other):
        ...
        if isinstance(other, Chip) and self.denomination == other.denomination:
            ...
            if new_quantity < 0:
                new_quantity = 0
            return Chip(self.denomination, new_quantity)
        return NotImplemented
